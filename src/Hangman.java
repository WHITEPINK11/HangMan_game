...
//
//    private static final List<String> DEFAULT_WORDS = Arrays.asList("apple", "banana", "computer", "java", "game");
//
...
//            words.removeIf(String::isEmpty); // Remove empty lines
//            if (words.isEmpty()) {
...
//    }
//
//    private static String getDefaultWord() {
//        System.out.println("Using default words because 'words.txt' is missing or empty.");
//        return DEFAULT_WORDS.get(new Random().nextInt(DEFAULT_WORDS.size()));
//    }
//
